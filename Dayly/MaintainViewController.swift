...
class MaintainViewController: UIViewController {
    ...
    @IBOutlet weak var bakc: UIButton!
    ...
    override func viewDidLoad() {
        ...
        bakc.setImage(image?.withRenderingMode(UIImage.RenderingMode.alwaysTemplate), for: .normal)
        bakc.tintColor = UIColor.init(red: 3/255, green: 132/255,
